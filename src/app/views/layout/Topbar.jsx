    ...
    >
      <MenuItem>
        <div className={classes.linkBtn}>
          <div>
            <Link to="/main">SETS</Link>
          </div>
          <div>
            <Link to="/main">SELinkLED</Link>
          </div>
          <div>
            <Link to="/main">INTERESTS</Link>
          </div>
          <div>
            <Link to="/main">LinkNLinkLYTICS</Link>
          </div>
          <div>
            <Link to="/main">DECKS</Link>
          </div>
          <div>
            <Link to="/main">PREMIUM</Link>
          </div>
          <div>
